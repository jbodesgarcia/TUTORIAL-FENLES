  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(190, 188, 24, 147),
      ),
      body: Column(
        children: [
          Padding(
            ...
            child: Column(
              children: [
                ...
                Slider(
                  ...
                  max: 50,
                  divisions: 50,
                  activeColor: const Color.fromARGB(255, 160, 83, 173),
                  inactiveColor: const Color.fromARGB(255, 61, 41, 75),
                  thumbColor: const Color.fromARGB(255, 59, 25, 97),
